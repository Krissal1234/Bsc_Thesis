...
object's centre, a bounding box or even as a list of pixels containing the
...
\paragraph{}
 ...
 external objects. Similarly to object detection, the human ability to perceive
...
\paragraph{}
CNN's, incorporate multiple layers and are capable of extracting effective
representations
...
gradients during the backpropogation procedure during the processing of extended sequences, as
...
introduced \cite{learningPriceseTimingWithLSTM}. LSTM netowrks unlike RNNs are
