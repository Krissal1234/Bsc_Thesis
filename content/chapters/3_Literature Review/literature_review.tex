...
set while simultaneously reducing the potential for model over-fitting
\cite{DietterichOverfittingAI} Consequently, they introduced an additional 2,250
images, achieving a total of 3,000 images in their data set. The researchers
applied three distinct augmentation techniques, including horizontal rotation,
positive 90\textdegree rotation and negative 90\textdegree rotation.
