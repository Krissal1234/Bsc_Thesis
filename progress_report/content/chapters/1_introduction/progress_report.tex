...
used are all multilayer feed-forward neural network (MFFNNs), structured into
...
these networks. Finally the study achieved a high accuracy with ANN X Y and Z all achieved an accuracy of
94.8\%, 96.7\% and 98.7\% respectively, while the combined ANN XYZ achievd an an
accuracy of 92.8\%.
