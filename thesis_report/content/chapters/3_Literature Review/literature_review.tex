...
which have been shown to be efficient at capturing temporal information.
...
the section 3.2. These studies strongly suggest exploring the use of various
...
The study by Shapiee et al. (2020) \cite{skatePaper1} leverages a custom data set
...
tricks commonly observed in competitive settings, illustrated in Figure \ref{fig:tricks}. The researcher collected 50
