...
systems , most scenarios that would benefit from Activity Recognition adopt
dynamic recording devices such as mobile phones or sports event broadcasts.
...
The camera distance, results in smaller subjecs, making detailed analysis of
...
Normalization is an important technique used in preprocessing to standardise the
...
min-max normalisation is particular prevalent. The research by Pei et al.
\cite{RobustnessInMLNormalisation}, underscores this, showing that normalizing
pixel intesities by dividing them by 255 to adjust the scale from 0 to 1
...
that the impact of normalization on model performance can vary depending on the
characteristics of the dataset. The contrasting conclusions presented in the studies
...
\paragraph{}
Feature extraction is a vital step in computer vision where patterns and
characteristics are are extracted in the data that makes classification 
