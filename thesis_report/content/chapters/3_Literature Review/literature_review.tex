...
Moreover, research on transfer learning is not unique within the field
of skateboard trick classification. Two other studies \cite{skatePaper1},
\cite{SkateboardAIPaper} have utilised this approach and achieved high
accuracies. However, a more in-depth analysis of these papers can be found in
...
linear accelerations along the x, y, and z axes (aX, aY, aZ) and
