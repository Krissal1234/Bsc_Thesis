...
effective DL architecture is the CNN-LSTM. It combines the strength of CNN's for
extracting spatial features from individual frames, with LSTM networks, which
capture the temporal information across frames.
