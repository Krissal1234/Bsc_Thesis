...
\cite{HumanActivityRecognitionSecurityAndMonitoring}. 
...
% maybe talk about hoe there HAR systems are either contact based or remote methods/vision based
...
accelerometers, wearable sensors and multi-touch interfaces. Complimenting this
perspective, the study by Cook et al. \cite{SensorBasedActivityRecognition}
delves into the the specifics of sensor technology, exploring how various sensor
types are significant in the field of activity recognition. Alternatively, Beddiar et al.
futher describe vision-based methods as simplifying HCI by enabling more natural human
communication, eliminating the need of for physical contact or equipment. These
methods use image and video data to recognise human activities offering an
advantage in terms of societal acceptance 
\paragraph{}
