...
set in order to reduce the potential for model over-fitting noted by \cite{DietterichOverfittingAI}. 
This paper utilises three distinct augmentation techniques, including horizontal rotation,
positive 90\textdegree rotation and negative 90\textdegree rotation.
Consequently, they introduced an additional 2,250
