...
patterns applied to each frame, . In order to
expand the number of training samples, this study created two copies of the
...
Certain augmentation techniques such as image flipping and large rotational
