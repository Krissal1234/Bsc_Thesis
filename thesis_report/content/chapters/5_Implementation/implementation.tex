...
the models to learn the patterns and relationships from the input data. The
...
\ref{fig:originalFrames-againstAugmented} shows an example of an augmented
duplication of a trick sequence against its original, split into six frames for
illustrative purposes. Experiments revealed that certain augmentation techniques
such as image flipping and large rotational shifts disrupted the visualisation
of the trick, negatively impacting model performance, thus these were removed
