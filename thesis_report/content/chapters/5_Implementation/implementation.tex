...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{content/chapters/5_Implementation/figures/pca_vgg.png} % replace "image2" with your file name
...
one-hot encoded labels. Furthermore,
%mention that they all used
