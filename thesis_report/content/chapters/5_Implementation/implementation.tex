...
training process, this chapter detail on how the previously established
...
visualisation functions, particularly during the evaluation stage to
...
unique augmentation parameters utilised in this study are illustrated in Figure~\ref{fig:augmentation_parameters}.
...
\subsection{Training Process and Hyperpameter Tuning}
...
Optuna provided initial configurations, which served as starting points for the
...
optimisor in Section 6.1.1. While SGD performed better than Adam in the context
of classifying skateboard tricks, it required longer training times to converge.
