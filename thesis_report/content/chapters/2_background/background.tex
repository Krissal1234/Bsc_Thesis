...
factors encompass dataset quality and diversity, the preprocessing of
...
\section{Activity Recognition}
 ...
 such activities \cite{ActionRecognitionDeepBi-DirectionalLSTM},\cite{AReviewOfHumanActivityRecognitionMethods}.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.85 \textwidth]{content/chapters/2_background/figures/Machine Learning/ANN_Diagram2.png} 
...
representations
-- continue explenation, explain how feature maps are created thorugh convolutions
...
exploding gradients during the backpropagation procedure during the processing
of extended sequences, as discussed in prior works
