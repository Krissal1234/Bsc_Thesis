...
\begin{itemize}
    ...
    that interacts with the environment and learns from the constant feedback
    it receives in the form of rewards or penalties.
\end{itemize}
...
Dimensionality Reduction aims to remove these unnecessary components
