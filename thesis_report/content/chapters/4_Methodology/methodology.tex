...
extraction, resulting in capturing frames with the most movement. An example of
this technique being applied to a skate trick can be observed in Figure
\ref{fig:kickflip-sequence-opticalflow}.
