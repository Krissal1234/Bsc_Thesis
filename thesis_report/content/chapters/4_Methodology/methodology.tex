...
trick due to its subjective nature. Whereas, by providing the model with a sequence of frames, as
illustrated in Figure \ref{fig:MultiFrameKickflip}, the entire trick
sequence is captured including the wind-up, the trick and the landing, capturing
actions such as foot placement and board rotation, collectively define the
skateboard trick.
