...
of these videos were selected and included in the final dataset. The final
dataset consisted of 128 videos per class adding up to a total of 384 videos.
...
of 16 convolutional and fully connected (FC) with repeated use of 3x3
convolutional filters to preserve spatial information within frames.%
...
\begin{enumerate}
	...
	model to extract features, which are then fed to an LSTM for sequence
	modelling. LSTMs are powerful for capturing long-term dependencies within
	sequential data such as skateboarding tricks.
