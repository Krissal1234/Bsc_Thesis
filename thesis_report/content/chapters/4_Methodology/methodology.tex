...
videos covering 15 tricks. However, since the majority of tricks were beyond
...
number of frames of a video. Whereas, the second technique leverages optical
flow to select the frames with the most significant movement. This method
calculates the motion of pixels between successive frames and assigns weights to
each frame determined by the magnitude of this motion. Figure
\ref{fig:kickflip-sequence-opticalflow} illustrates a visualisation of this
technique being applied to "kickflip" trick.
