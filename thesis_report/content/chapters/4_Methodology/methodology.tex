...
number of frames the video has. The second technique leveraged optical flow, a
...
the vide frame data before further processing. In particular this study
utilised min-max normalisation to scale the pixel intesities between 0 and 1.
Normalising data in this manner ensured that the model's input values data was
within a stanardised range.
