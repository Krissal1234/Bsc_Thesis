...
Given this research is involved in writing 
...
over-parameterised nature of the chosen models, meaning that their number of
trainable paramaters surpass the size of the dataset, making it very vulnerable
to overfitting.
