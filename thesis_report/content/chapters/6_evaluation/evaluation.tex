...
%section in this chapter indicating how long it takes to proproscess and applyu the model to a singular video 
%to determine if its applicatble to be real-time


\section{Applicability In Real-Time applications}
For real-time applications like analysing skatebaord events, the speed at which
data is processed is crucial. To evaluate the models applicability in such
...
the sequence model.
While they are relatively slow, they are still applicable in real-time events
% kthen look into times between tricks 