...
\section{The Effect of PCA}
This section evaluates the impact of PCA on the performance of the selected
sequence models. The analysis compares VGG16-BiLSTM and ResNet50-BiLSTM as they
are the top-performing models from each category of pre-trained models, This
comparison focuses on their accuracies before and after the application of PCA,
...
side-by-side comparison of these models with their training times along with the
