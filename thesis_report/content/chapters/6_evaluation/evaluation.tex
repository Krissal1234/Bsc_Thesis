...
with the VGG-BiLSTM align with the insights discussed by Hardt et al.
...
caused by the computationally expensive video analysis pipeline required to
...
This section provides a comparative analysis of the outcomes of this study
...
comparison accuracies are detailed in Table~\ref{tab:models_results}. Chen's
top-performing model, the ResNet50 + Attention + BiLSTM model, achieved an
accuracy of 84\%. In contrast, this study achieved a higher accuracy with an
average training time reduction of 41:04 minutes across all models.
...
the absence of rotation around the y-axis, which distinguishes them from the
pop-shuvit. The confusion matrices illustrated in Figure~\ref{fig:model_cm}
demonstrates a favourable classification rate on pop-shuvit's across all models
