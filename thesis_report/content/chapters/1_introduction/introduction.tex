...
\begin{figure}[htbp]
	...
	\caption{Number of skateboarding participants in the United States from 2010
	to 2021 in millions. Reproduced from~\cite{skatestatistics}, data sourced from
	Outdoor Foundation~\cite{outdoorfounation}.}\label{fig:skate_graph}
\end{figure}
...
\begin{itemize}
	\item Implement a set of Deep learning architectures and evaluate them using appropriate metrics.
	\item Explore and employ suitable frame processing techniques.
	\item Augment and preprocess the frames to determine any performance improvement.
\end{itemize}
