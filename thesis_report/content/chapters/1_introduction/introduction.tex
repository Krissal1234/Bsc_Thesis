...
demonstrated by the spike in the number U.S. skateboarding participants between
the years 2020 and 2021, as illustrated in Figure \ref{fig:skate_graph}.
...
YouTube and Instagram has increased the demand for on-screen trick
identification %add reference 
, enabling inexperienced viewers to identify tricks performed by
skaters in videos through a digital overlay that labels each manoeuvre.
...
could save time in this regard, but also offer real-time benefits for live streamed
content, such as skateboard competitions and events, providing insightful
footage to viewers, further enhancing the understanding and appreciation for the
...
Despite the popularity in computer vision, particularly in video activity
recognition, limited research exists in the domain of skateboard trick
classification. While some initial studies such as, Shapiee et al. (2020)
\cite{skatePaper1} and Hanxiao Chen (2023) \cite{SkateboardAIPaper} explored
this domain, there remains a gap in research, driving the need for further
growth in this area.% define the gap
...
\begin{itemize}
	...
	\item Augment and preprocess the images to determine any improvement on performance.
\end{itemize}
...
and identified limitations that this research encountered.
