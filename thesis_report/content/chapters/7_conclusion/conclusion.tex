...
This study set out to explore the potential of Deep Learning techniques in the
classifying skateboard trick from video data, addressing a gap in the field. The
hypothesis asserted that the combination of advanced Deep Learning models and
strategic preprocessing could enhance the robustness and accuracy of
skateboarding trick classification.

Throughout this research, four architectures were implemented:
VGG16-LSTM, VGG16-BiLSTM, ResNet50-LSTM and ResNet50-BiLSTM. These models were
compared against each other, and the effectiveness of several preprocessing
techniques such as Optical Flow, PCA and data augmentation was evaluated to
understand their impact on training efficiencies and training accuracies

% This study presents its findings in Chapter 6, using relevant
...
In addressing the research questions, this research has successfully
demonstrated the effectiveness of Deep Learning in the domain of skateboard
trick classification, with the VGG16-BiLSTM model achieving the highest
performance at 88\% accuracy. Moreover, this study has also highlighted the effectiveness of
various preprocessing techniques through a number of experiments detailed in
Chapter~\ref{6_evaluation}, confirming their role in enhancing performance.

\noindent
The aims and objectives of this research were achieved as follows:
\begin{itemize}
  \item \textbf{Classifying skateboard tricks using video frames:} The adapted
  models successfully classified skateboard tricks into their respective classes
  at favourable accuracies, ranging from 80\% to 88\%.
  \item \textbf{Evaluating and comparing Deep Learning architectures:} The
  performance of the adapted models was assessed, with the VGG16-BiLSTM emerging
  as the top performer, while the ResNet50-LSTM performed slightly worse than
  the other architectures.
  \item \textbf{Examining preprocessing techniques:} Various preprocessing
  methods were implemented and evaluated, demonstrating their ability to improve
  model performance and training effectiveness.
\end{itemize}
...
In conclusion, the hypothesis claiming that a combination of advanced Deep
Learning models and preprocessing techniques could enhance classification
performance was validated. Thus, this research has successfully demonstrated the
potential for Deep Learning in the domain of skateboard trick classification,
achieving its aims and objectives and contributing knowledge to the field.
